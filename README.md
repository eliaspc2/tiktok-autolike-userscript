...
- The script waits for the TikTok player to mount, checks accessible same-origin frames, and then tries the real unmute control or the `M` shortcut when the player still appears muted.
